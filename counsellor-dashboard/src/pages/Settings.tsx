          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-muted-foreground">Get notified when students request appointments</p>
              </div>
              <Switch
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-muted-foreground">High-priority questions requiring immediate attention</p>
              </div>
              <Switch
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-muted-foreground">Journal entries that need review</p>
              </div>
              <Switch
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-muted-foreground">Daily digest of platform activity</p>
              </div>
              <Switch
          ...
          <div className="space-y-4">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-sm text-muted-foreground">Allow students to see your profile information</p>
              </div>
              <Switch
