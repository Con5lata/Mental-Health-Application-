          ...
          <CardContent className="p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-customBlue">Appointments</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-customBlue">Active Students</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-customBlue">Q&A Responses</p>
              </div>
            </div>
          </CardContent>
        </Card>
          ...
          <CardContent className="p-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-customBlue">Journal Reviews</p>
              </div>
            </div>
          </CardContent>
        </Card>
              ...
              {appointmentData.map((data, index) => (
                <div key={index} className="flex items-center justify-between p-4 rounded-lg bg-muted/30">
                  ...
                  <div className="text-right">
                    ...
                    <p className="text-xs text-customBlue">appointments</p>
                  </div>
                </div>
              ))}
            </div>
              ...
              {moodTrends.map((mood, index) => (
                <div key={index} className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-sm text-customBlue">{mood.count} students</span>
                  </div>
                  ...
                  <div className="text-right text-xs text-customBlue">
                    {mood.percentage}%
                  </div>
                </div>
              ))}
              ...
              <div key={index} className="p-6 rounded-lg border border-border">
                <div className="space-y-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-customBlue">requests</p>
                  </div>
                </div>
              </div>
            ))}
